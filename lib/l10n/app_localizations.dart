...
abstract class AppLocalizations {
  ...
  /// Localized fronting preset phrase: Long-running header, singular
  ///
  /// In en, this message translates to:
  /// **'{preset, select, fronting{Long-running front} present{Long-running presence} out{Long-running out session} online{Long-running online session} other{Long-running front}}'**
  String terminologyFrontingPresetLongRunningHeaderSingularLabel(String preset);
