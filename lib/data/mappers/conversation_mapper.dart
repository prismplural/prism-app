...
class ConversationMapper {
  ...
  static domain.Conversation toDomain(Conversation row) {
    ...
    return domain.Conversation(
      ...
      includesAllMembers: row.includesAllMembers,
      archivedForEveryone: row.archivedForEveryone,
  ...
  static ConversationsCompanion toCompanion(domain.Conversation model) {
    ...
    return ConversationsCompanion(
      ...
      includesAllMembers: Value(model.includesAllMembers),
      archivedForEveryone: Value(model.archivedForEveryone),
