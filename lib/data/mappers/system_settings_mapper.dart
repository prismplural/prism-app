...
class SystemSettingsMapper {
  ...
  static domain.SystemSettings toDomain(SystemSettingsData row) {
    return domain.SystemSettings(
      ...
      memberNameDisplay: enumByIndex(
        row.memberNameDisplay,
        domain.MemberNameDisplay.values,
      ...
      paletteSeedColorHex: row.paletteSeedColorHex,
      paletteMood: enumByIndex(
        row.paletteMood,
        domain.PaletteMood.values,
        domain.PaletteMood.tonal,
      ),
      paletteContrast: enumByIndex(
        row.paletteContrast,
        domain.PaletteContrast.values,
        domain.PaletteContrast.standard,
      ),
  ...
  static SystemSettingsTableCompanion toCompanion(domain.SystemSettings model) {
    return SystemSettingsTableCompanion(
      ...
      memberNameDisplay: Value(model.memberNameDisplay.index),
      ...
      paletteSource: Value(model.paletteSource.index),
      paletteSeedColorHex: Value(model.paletteSeedColorHex),
      paletteMood: Value(model.paletteMood.index),
      paletteContrast: Value(model.paletteContrast.index),
