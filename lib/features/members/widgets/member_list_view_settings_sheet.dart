...
class MemberListViewSettingsSheet extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final hasGroups = ref.watch(allGroupsProvider).value?.isNotEmpty ?? false;
            ...
            Expanded(
              child: ListView(
                ...
                children: [
                        ...
                        ? Column(
                            ...
                            children: [
                              _SettingsSection(
                                ...
                                child:
                                    PrismSegmentedControl<MembersListViewMode>(
                                      selected: viewMode,
                                      onChanged: (mode) {
                                        ref
                                            .read(
                              ...
                              if (viewMode ==
                                ...
                                _SettingsSection(
                                  ...
                                  description:
                                      l10n.memberGroupedDefaultStateDescription,
                                  child:
                                      ...
                                      >(
                                        ...
                                        segments: [
                                          ...
                                          PrismSegment(
                                            value: MembersGroupedDefaultState
                                                .closed,
                                            label: l10n
                                ...
                                _SettingsSection(
                                  ...
                                  child:
                                      ...
                                      >(
                                        ...
                                        segments: [
                                          PrismSegment(
                                            value: MembersFolderMemberVisibility
                                                .allMembers,
                                            label:
                  ...
                  const SizedBox(height: 24),
                  _SettingsSection(
                    title: l10n.memberListDisplayLabel,
                    child: PrismSwitchRow(
                      title: l10n.memberShowPronounsToggle,
                      subtitle: l10n.memberShowPronounsToggleDescription,
                      value: showPronouns,
                      padding: const EdgeInsets.symmetric(vertical: 10),
                      onChanged: (value) {
                        ref
                            .read(settingsNotifierProvider.notifier)
                            .updateMembersShowPronouns(value);
                      },
                    ),
                  ),
                ],
