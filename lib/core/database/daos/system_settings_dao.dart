...
class SystemSettingsDao extends DatabaseAccessor<AppDatabase>
  ...
  Future<SystemSettingsData> getSettings() async {
    final result = await (select(systemSettingsTable)
    ...
    return (select(systemSettingsTable)
          ..where((s) => s.id.equals(_singletonId)))
        .getSingle();
  }
  ...
  Future<void> _updateField(SystemSettingsTableCompanion companion) =>
  ...
  Future<void> updateNotesEnabled(bool value) =>
      _updateField(
          SystemSettingsTableCompanion(notesEnabled: Value(value)));
  ...
  Future<void> updateNavBarOverflowItems(String value) =>
      _updateField(
  ...
  Future<void> updateChatBadgePreferences(String value) =>
      _updateField(
  ...
  Future<void> updateFrontingReminderIntervalMinutes(int value) =>
      _updateField(SystemSettingsTableCompanion(
          frontingReminderIntervalMinutes: Value(value)));

  Future<void> updateQuickSwitchThresholdSeconds(int value) =>
      _updateField(SystemSettingsTableCompanion(
          quickSwitchThresholdSeconds: Value(value)));
  ...
  Future<void> updateFeatureToggles({
    ...
    final companion = SystemSettingsTableCompanion(
      chatEnabled:
          chatEnabled != null ? Value(chatEnabled) : const Value.absent(),
      pollsEnabled:
          pollsEnabled != null ? Value(pollsEnabled) : const Value.absent(),
      habitsEnabled:
          habitsEnabled != null ? Value(habitsEnabled) : const Value.absent(),
