...
mixin _$FrontingSession {
 ...
 String get id; DateTime get startTime; DateTime? get endTime; String? get memberId; List<String> get coFronterIds; String? get notes; FrontConfidence? get confidence; String? get pluralkitUuid; SessionType get sessionType; SleepQuality? get quality; bool get isHealthKitImport; String? get pkMemberIdsJson;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is FrontingSession&&(identical(other.id, id) || other.id == id)&&(identical(other.startTime, startTime) || other.startTime == startTime)&&(identical(other.endTime, endTime) || other.endTime == endTime)&&(identical(other.memberId, memberId) || other.memberId == memberId)&&const DeepCollectionEquality().equals(other.coFronterIds, coFronterIds)&&(identical(other.notes, notes) || other.notes == notes)&&(identical(other.confidence, confidence) || other.confidence == confidence)&&(identical(other.pluralkitUuid, pluralkitUuid) || other.pluralkitUuid == pluralkitUuid)&&(identical(other.sessionType, sessionType) || other.sessionType == sessionType)&&(identical(other.quality, quality) || other.quality == quality)&&(identical(other.isHealthKitImport, isHealthKitImport) || other.isHealthKitImport == isHealthKitImport)&&(identical(other.pkMemberIdsJson, pkMemberIdsJson) || other.pkMemberIdsJson == pkMemberIdsJson));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,startTime,endTime,memberId,const DeepCollectionEquality().hash(coFronterIds),notes,confidence,pluralkitUuid,sessionType,quality,isHealthKitImport,pkMemberIdsJson);

@override
String toString() {
  return 'FrontingSession(id: $id, startTime: $startTime, endTime: $endTime, memberId: $memberId, coFronterIds: $coFronterIds, notes: $notes, confidence: $confidence, pluralkitUuid: $pluralkitUuid, sessionType: $sessionType, quality: $quality, isHealthKitImport: $isHealthKitImport, pkMemberIdsJson: $pkMemberIdsJson)';
}
...
@useResult
$Res call({
 String id, DateTime startTime, DateTime? endTime, String? memberId, List<String> coFronterIds, String? notes, FrontConfidence? confidence, String? pluralkitUuid, SessionType sessionType, SleepQuality? quality, bool isHealthKitImport, String? pkMemberIdsJson
});
...
/// Create a copy of FrontingSession
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? startTime = null,Object? endTime = freezed,Object? memberId = freezed,Object? coFronterIds = null,Object? notes = freezed,Object? confidence = freezed,Object? pluralkitUuid = freezed,Object? sessionType = null,Object? quality = freezed,Object? isHealthKitImport = null,Object? pkMemberIdsJson = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  DateTime startTime,  DateTime? endTime,  String? memberId,  List<String> coFronterIds,  String? notes,  FrontConfidence? confidence,  String? pluralkitUuid,  SessionType sessionType,  SleepQuality? quality,  bool isHealthKitImport,  String? pkMemberIdsJson)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _FrontingSession() when $default != null:
return $default(_that.id,_that.startTime,_that.endTime,_that.memberId,_that.coFronterIds,_that.notes,_that.confidence,_that.pluralkitUuid,_that.sessionType,_that.quality,_that.isHealthKitImport,_that.pkMemberIdsJson);case _:
  return orElse();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,startTime,endTime,memberId,const DeepCollectionEquality().hash(_coFronterIds),notes,confidence,pluralkitUuid,sessionType,quality,isHealthKitImport,pkMemberIdsJson);
...
/// Create a copy of FrontingSession
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? startTime = null,Object? endTime = freezed,Object? memberId = freezed,Object? coFronterIds = null,Object? notes = freezed,Object? confidence = freezed,Object? pluralkitUuid = freezed,Object? sessionType = null,Object? quality = freezed,Object? isHealthKitImport = null,Object? pkMemberIdsJson = freezed,}) {
