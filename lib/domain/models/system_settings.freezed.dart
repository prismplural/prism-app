...
class _SystemSettings implements SystemSettings {
  const _SystemSettings({this.systemName, this.sharingId, this.showQuickFront = true, this.accentColorHex = '#AF8EE9', this.perMemberAccentColors = true, this.terminology = SystemTerminology.headmates, this.customTerminology, this.customPluralTerminology, this.frontingRemindersEnabled = false, this.frontingReminderIntervalMinutes = 60, this.themeMode = AppThemeMode.system, this.themeBrightness = ThemeBrightness.system, this.themeStyle = ThemeStyle.standard, this.chatEnabled = true, this.pollsEnabled = true, this.habitsEnabled = true, this.sleepTrackingEnabled = true, this.gifSearchEnabled = true, this.voiceNotesEnabled = true, this.sleepSuggestionEnabled = false, this.sleepSuggestionHour = 22, this.sleepSuggestionMinute = 0, this.wakeSuggestionEnabled = false, this.wakeSuggestionAfterHours = 8.0, this.quickSwitchThresholdSeconds = 30, this.identityGeneration = 0, this.chatLogsFront = false, this.terminologyUseEnglish = false, this.hasCompletedOnboarding = false, this.syncThemeEnabled = false, this.habitsBadgeEnabled = true, this.timingMode = FrontingTimingMode.flexible, this.notesEnabled = true, this.previousAccentColorHex = '', this.systemDescription, @JsonKey(fromJson: _uint8ListFromJson, toJson: _uint8ListToJson) this.systemAvatarData, this.remindersEnabled = true, this.localeOverride, this.gifConsentState = GifConsentState.unknown, this.fontScale = 1.0, this.fontFamily = FontFamily.system, this.pinLockEnabled = false, this.biometricLockEnabled = false, this.autoLockDelaySeconds = 0, this.displayFontInAppBar = true, final  List<String> navBarItems = const <String>[], final  List<String> navBarOverflowItems = const <String>[], this.syncNavigationEnabled = true, final  Map<String, String> chatBadgePreferences = const <String, String>{}}): _navBarItems = navBarItems,_navBarOverflowItems = navBarOverflowItems,_chatBadgePreferences = chatBadgePreferences;
