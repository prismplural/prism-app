...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,systemName,sharingId,showQuickFront,accentColorHex,perMemberAccentColors,terminology,customTerminology,customPluralTerminology,frontingRemindersEnabled,frontingReminderIntervalMinutes,themeMode,themeBrightness,themeStyle,chatEnabled,pollsEnabled,habitsEnabled,sleepTrackingEnabled,gifSearchEnabled,voiceNotesEnabled,quickSwitchThresholdSeconds,identityGeneration,chatLogsFront,terminologyUseEnglish,hasCompletedOnboarding,syncThemeEnabled,habitsBadgeEnabled,timingMode,notesEnabled,previousAccentColorHex,systemDescription,const DeepCollectionEquality().hash(systemAvatarData),remindersEnabled,localeOverride,gifConsentState,fontScale,fontFamily,pinLockEnabled,biometricLockEnabled,autoLockDelaySeconds,displayFontInAppBar,const DeepCollectionEquality().hash(navBarItems),const DeepCollectionEquality().hash(navBarOverflowItems),syncNavigationEnabled,const DeepCollectionEquality().hash(chatBadgePreferences)]);
