...
$GroupSortStateCopyWith<$Res> get sortState;
...
as DateTime,sortState: null == sortState ? _self.sortState : sortState // ignore: cast_nullable_to_non_nullable
as GroupSortState,
  ));
}
/// Create a copy of MemberGroup
...
$GroupSortStateCopyWith<$Res> get sortState {
  ...
  return $GroupSortStateCopyWith<$Res>(_self.sortState, (value) {
    return _then(_self.copyWith(sortState: value));
  });
}
}
...
@override@JsonKey() final  GroupSortState sortState;
...
@override $GroupSortStateCopyWith<$Res> get sortState;
