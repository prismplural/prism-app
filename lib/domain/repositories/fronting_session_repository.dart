...
abstract class FrontingSessionRepository {
  ...
  /// Soft-deleted sleep tombstones. The recovery flow re-creates each under a
  /// deterministic id ([deriveSleepRecoverySessionId]) via [createSession];
  /// the tombstones themselves are left in place.
