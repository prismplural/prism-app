...
String resolveFieldTypeLabel(
  ...
  return switch (labelL10nKey) {
    ...
    'customFieldTypeMember' => memberTypeLabel ?? l10n.customFieldTypeMember,
    _ => labelL10nKey,
  };
}
...
String localizedFieldTypeLabel(
  AppLocalizations l10n,
  CustomField field, {
  String? memberTypeLabel,
}) {
