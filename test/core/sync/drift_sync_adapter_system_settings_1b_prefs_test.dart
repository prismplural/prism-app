...
void main() {
  test('fronting prefs round-trip through sync adapter', () async {
    ...
    await db.systemSettingsDao.updateAutoPromoteLongFrontingSessions(false);
    ...
    expect(packed['auto_promote_long_fronting_sessions'], isFalse);
    ...
    expect(row.autoPromoteLongFrontingSessions, isTrue);
