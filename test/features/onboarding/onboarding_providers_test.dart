...
void main() {
  ...
  group('OnboardingCommitService', () {
    test('completes onboarding using persisted members and repositories', () async {
      ...
      final settingsRepository = _FakeSystemSettingsRepository();
      final conversationRepository = _FakeConversationRepository();
      final frontingRepository = _FakeFrontingSessionRepository();
...
class _FakeSystemSettingsRepository implements SystemSettingsRepository {
