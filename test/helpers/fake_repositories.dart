...
class FakeSystemSettingsRepository implements SystemSettingsRepository {
  ...
  Future<void> updateBioMarkdownEnabled(bool value) async =>
      updateSettings(settings.copyWith(bioMarkdownEnabled: value));
  @override
  ...
  Future<void> updateMemberNameDisplay(MemberNameDisplay value) async =>
      updateSettings(settings.copyWith(memberNameDisplay: value));
  @override
  Future<void> updatePaletteSource(PaletteSource value) async =>
      updateSettings(settings.copyWith(paletteSource: value));
  @override
  Future<void> updatePaletteSeedColorHex(String hex) async =>
      updateSettings(settings.copyWith(paletteSeedColorHex: hex));
  @override
  Future<void> updatePaletteMood(PaletteMood value) async =>
      updateSettings(settings.copyWith(paletteMood: value));
  @override
  Future<void> updatePaletteContrast(PaletteContrast value) async =>
      updateSettings(settings.copyWith(paletteContrast: value));
  @override
  ...
  @override
  Future<void> updateMembersListViewMode(MembersListViewMode value) async =>
      updateSettings(settings.copyWith(membersListViewMode: value));
  @override
  Future<void> updateMembersGroupedDefaultState(
    MembersGroupedDefaultState value,
  ) async =>
      updateSettings(settings.copyWith(membersGroupedDefaultState: value));
  @override
  ...
  Future<void> updateMembersShowGroups(bool value) async =>
      updateSettings(settings.copyWith(membersShowGroups: value));
  @override
  Future<void> updateMembersFrontButtonBehavior(
    FrontStartBehavior value,
  ) async =>
      updateSettings(settings.copyWith(membersFrontButtonBehavior: value));
  @override
